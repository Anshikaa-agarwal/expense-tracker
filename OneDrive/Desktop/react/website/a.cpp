...
void TSP()
{
  ...
  void updatespeed()
  {
      ...
      while (1)
      {
          ...
          if (sp>80) cout<<"          Speed cannot be greater than 80 km/h";
          else if (sp<=15) cout<<"          Enter valid speed, above 15 km/h";
          else
          {
              speed=sp;
  ...
  void currenttraffic()
  {
      ...
      while (1)
      {
          ...
          else
          {
              ...
              if(d1==d2) cout<<"\n\n          Please enter different districts";
              else if (adj[d1][d2].dist==10000) cout<<"\n\n          Sorry, no direct road exists between these two districts!";
              else
              {
